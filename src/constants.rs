...
pub const PIECE_MOVE_COLUMN_DISAMBIGUATION_REGEX: &str =
    r"^([KQBNR])([a-h])([a-h])([1-8])(\+|\#)?$";
pub const PIECE_MOVE_ROW_AND_COLUMN_DISAMBIGUATION_REGEX: &str =
    r"^([KQBNR])([a-h])([1-8])([a-h])([1-8])(\+|\#)?$";
pub const PIECE_CAPTURE_ROW_DISAMBIGUATION_REGEX: &str =
    r"^([KQBNR])([1-8])x([a-h])([1-8])(\+|\#)?$";
pub const PIECE_CAPTURE_COLUMN_DISAMBIGUATION_REGEX: &str =
    r"^([KQBNR])([a-h])x([a-h])([1-8])(\+|\#)?$";
pub const PIECE_CAPTURE_ROW_AND_COLUMN_DISAMBIGUATION_REGEX: &str =
    r"^([KQBNR])([a-h])([1-8])x([a-h])([1-8])(\+|\#)?$";
